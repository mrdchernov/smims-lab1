...
export default function CreateBreed(): JSX.Element {
    ...
    return <div style={{ height: '100vh' }}>
        <Header title={'Expert View'}
                actionBtn={<Button onClick={() => router.back()} color="inherit">Cancel</Button>}/>
        ...
        <div className={style.stepperWrapper}>
            ...
            <div className={style.stepperBtns}>
                ...
                <Button variant="contained" color="primary" onClick={handleNext}>
                    {loader ?
                        <CircularProgress color={'secondary'}/> : activeStep === steps.length - 1 ? 'Save' : 'Next'}
                </Button>
            </div>
        </div>
    </div>
